...
import kultalaaki.vpkapuri.dbresponder.ResponderAdapter;
import kultalaaki.vpkapuri.dbresponder.ResponderViewModel;
import kultalaaki.vpkapuri.misc.AutoFitGridLayoutManager;
...
public class ResponderFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ResponderViewModel.class);
